...
class _CadastroClienteScreenState extends State<CadastroClienteScreen> {
  ...
  Future<void> _salvarCliente() async {
    // Verifica se há pelo menos um plano cadastrado
    if (_planos.isEmpty) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('É necessário cadastrar pelo menos um plano antes de cadastrar um cliente.'),
                    ...
                    TextButton.icon(
                      onPressed: () {
                        Navigator.push(
                          ...
                          // Recarrega os planos após voltar da tela de cadastro
                          if (mounted) {
                            _carregarPlanos();
                          }
                        });
